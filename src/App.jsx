      ...
      <header className="bg-gradient-to-br from-gray-900 to-gray-800 text-white p-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="space-x-6 hidden md:block">
            ...
            <button onClick={scrollToContact} className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">
              Get a Quote
            </button>
          </nav>
        </div>
        ...
        <div className="text-center mt-16">
          ...
          <div className="space-x-4">
            <button onClick={scrollToContact} className="bg-red-600 px-6 py-3 rounded-lg text-white font-semibold hover:bg-red-700">
              Get a Free Quote
            </button>
            <button className="bg-white text-red-600 px-6 py-3 rounded-lg border border-red-600 hover:bg-red-50">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section id="packages" className="bg-gray-100 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[ 
              { title: 'Basic Refresh', price: '$4,999', features: ['Paint + Flooring', 'Basic Fixtures', 'Small Kitchen/Bath'] },
              { title: 'Advanced Makeover', price: '$14,999', features: ['Open Concept Redesign', 'Modern Kitchen', 'Smart Bathroom', 'Exterior Upgrade'], featured: true },
              { title: 'Premium Transformation', price: '$29,999', features: ['Full Home Gut & Rebuild', 'Custom Design', 'Premium Materials', 'Dedicated Project Manager'] },
